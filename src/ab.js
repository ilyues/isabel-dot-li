        ...
        <div className="profile-text">
          <div className="title">
            ...
            <div className="bio">
              ...
              <p>
                <b>
                  I'm a multidisciplinary creative and student developer
                  pursuing a degree in computer science from UC Berkeley.
                </b>
              </p>
              <p>
                ...
                <li>Design which seeks to enable and empower all.</li>
                <li>
                  Art that brings joy and pushes the boundaries of the medium.
                </li>
                <li>
                  Technology, as a tool to break open new potential for all of
                  the above.
                </li>
              </p>
              <p>
              ...
              <p>
                ...
                surprise me), and intern opportunities in product design and
